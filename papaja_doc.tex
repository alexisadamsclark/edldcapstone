...
\hypersetup{
  pdftitle={COVID-19-Related Institutional Betrayal Among Undergraduate Students},
...
\emph{Special Note for Daniel and Joe- This is a super rough draft! If I had more time, I'd tinker around with the tables a little bit more to get the variable names to be better, but it just wasn't behaving! This is also one part of a (hopefully) 2-part study. Thanks!}

The authors made the following contributions. Alexis Adams-Clark: Conceptualization, Writing - Original Draft Preparation, Writing - Review \& Editing; Jennifer Freyd: Conceptualization.
